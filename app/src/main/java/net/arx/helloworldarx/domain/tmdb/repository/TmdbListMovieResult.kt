...
sealed class TmdbListMovieResult {
    class SuccessListMovieResult(val movieDetails: List<LocalMovie>) : TmdbListMovieResult()

    class NetworkWaringResult(val movieDetails: List<LocalMovie>): TmdbListMovieResult()
